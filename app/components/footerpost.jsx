...
import { SOCIAL_LINKS, SITE_CONFIG } from '../lib/types'
...
export const FooterPost = () => {
  return (
    <>
      <footer className="aria-labelledby='footer-heading' bg-white">
          ...
          <div className="mt-1 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
            ...
            <div className="md:order-1">
              ...
              <Link href="/lara-alonso-portfolio">
                <p className="text-xs mt-1 font-medium text-violet-600 hover:text-violet-700 transition-colors duration-200">
                  ¡Tu visión mi código!
                </p>
              </Link>
            </div>
      ...
      <Link href="/atribuciones">
        <div className="pt-8 text-xs leading-5 md:order-1 md:mt-0 pl-8 pb-8 transition-colors duration-200 bg-white text-gray-300 hover:text-gray-500">
