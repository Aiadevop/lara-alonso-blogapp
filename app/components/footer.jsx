...
export const Footer = () => {
    return (
        <>
            ...
            <Link href="/atribuciones"><div className='bg-white text-gray-300 pt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0 pl-8 pb-8'>Gracias a todos los que han colaborado en este blog</div></Link> 
        </>
    )
}
