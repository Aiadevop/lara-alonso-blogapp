...
const posts = [
  {
    id: 1,
    title: 'Crea tu primera aplicación en NextJS 13',
    href: '#',
    description:
      'Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.',
    imageUrl:
      "/img/initialapp.PNG ",
    date: 'Vie 02 Junio 2023',
    datetime: '2023-06-02',
    author: {
      name: 'Lara Alonso',
      imageUrl:
        "/img/profileIcon.jpeg "
    },
  },
  {
    id: 2,
    title: 'Como poner Attach como debugger en VSC',
    href: '#',
    description:
      'Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.',
    imageUrl:
  ...
  {
    id: 3,
    title: 'Como crear rutas en Next 13',
    href: '#',
    description:
      'Illo sint voluptas. Error voluptates culpa eligendi. Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde. Sed exercitationem placeat consectetur nulla deserunt vel. Iusto corrupti dicta.',
    imageUrl:
